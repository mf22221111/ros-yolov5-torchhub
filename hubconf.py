...
from src.first_ros.scripts.yolo.models.yolo import Model
from src.first_ros.scripts.yolo.utils.general import check_requirements, set_logging
from src.first_ros.scripts.yolo.utils.google_utils import attempt_download
from src.first_ros.scripts.yolo.utils.torch_utils import select_device
...
def custom(path_or_model='src/first_ros/scripts/yolo/path/to/yolov5s.pt', autoshape=True):
